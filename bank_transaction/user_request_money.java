...
public class user_request_money extends AppCompatActivity implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_request_money);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (amount.equalsIgnoreCase("")) {
                    ...
                    JR.json_response = (JsonResponse) user_request_money.this;
                    String q = "/user_request_money?amount=" + amount+"&customer_id="+customer_id+"&log_id="+log_id ;
                    q = q.replace(" ", "%20");
                    JR.execute(q);
                }
            }
    ...
    public void onBackPressed()
    {
        ...
        super.onBackPressed();
        Intent b=new Intent(getApplicationContext(),user_search.class);
        startActivity(b);
    }
}