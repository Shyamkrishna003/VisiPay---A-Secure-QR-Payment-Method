...
public class user_view_payment extends AppCompatActivity implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JR.json_response = (JsonResponse) user_view_payment.this;
        String q = "/user_view_payment?login_id="+log_id+"&customer_id="+customer_id;
        q = q.replace(" ", "%20");
        JR.execute(q);
    }
